...
console.log(`${salesTotalsDir} ya existe.`);
}
...
await fs.writeFile(path.join(salesTotalsDir, "totals.txt"), `${salesTotal.toFixed(2)}\r\n`, { flag: "a" });


console.log(`Escrito sales totals a ${salesTotalsDir}`);
}
