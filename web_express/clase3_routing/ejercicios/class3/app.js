...
app.get("/ab?cd", (req, res) => {
  res.send("get1: Acepta las rutas /abcd y /acd");
});
app.get("/ab+cd", (req, res) => {
  res.send("get2: Acepta las rutas /abcd /abbcd /abbbcd, etc.");
});
app.get("/ef*gd", (req, res) => {
  res.send("get3: Acepta las rutas /efgd /efcgd /efRABDOMgd /ef123gd, etc.");
});
// Path con expresiones regulares
app.get(/.*fly$/, (req, res) => {
  res.send(
    "get4: /butterfly y /dragonfly, pero no con /butterflyman, /dragonflyman, etc."
  );
});
