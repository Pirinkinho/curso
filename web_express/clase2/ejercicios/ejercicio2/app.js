...
// Crear un objeto de fecha y ajustarlo al horario de Madrid
  const madridTime = new Date(timestamp).toLocaleString("es-ES", {
  timeZone: "Europe/Madrid",
});

// Imprimir el tiempo en formato humano, hora de Madrid
console.log("Hora de España peninsular:", madridTime);
